...
#define tstring string
 ...
 struct IDUIControlBase; 
 struct CtrlBase
 {
 	OLE_HANDLE             m_pDataBlock;
 	OLE_HANDLE             m_pCtrl;
 ...
 CtrlBase(OLE_HANDLE hData)
 {
  if(hData)
  {
    m_pDataBlock = hData;
    m_pCtrl = (OLE_HANDLE)GetDUIControlFromDataBlock((void*)hData);
  }
 }
 ...
 bool operator==(const CtrlBase * pCtrl) const
 {
  if(pCtrl == NULL)
  {
     return false;
  }
   return pCtrl->m_pDataBlock == m_pDataBlock;
 }
 ...
 struct __declspec(uuid("3b1e89b6-61f4-4900-a231-266643ca00d2")) IDUICtrlAniResize;
struct __declspec(uuid("d1a9f0e6-2cf5-4c26-b8fc-66434be9b496")) DUICtrlAniResize;
struct __declspec(uuid("a1d34dfb-e7fc-4df0-bc59-f5448b5e5994")) _IDUICtrlAniResizeEvents;
struct __declspec(uuid("2ace08b1-723d-490d-a7f9-fae5fc67b2ca")) IDUICtrlAniMove;
struct __declspec(uuid("199c3242-e965-4ce4-9adf-51448bd8426b")) DUICtrlAniMove;
struct __declspec(uuid("27ba8f99-fc72-4e00-b5cb-4f24416fb1cc")) _IDUICtrlAniMoveEvents;
struct __declspec(uuid("f7ef77cf-3b92-4267-b07a-665fd02c2d45")) DUICtrlAniBase;
struct __declspec(uuid("fe686e80-1411-4c0d-87f3-7269e97bba4c")) _IDUICtrlAniBaseEvents;
struct __declspec(uuid("7a812e9f-4407-43d7-908f-188ff9618607")) IDUICtrlAniBase;
enum DUI_ANIMATE_TYPE;

struct __declspec(uuid("c7033505-0a8f-4412-bd54-93f89db162cd")) IDUIAnimateManager;
struct __declspec(uuid("79e96584-7370-4632-b8e1-a257551f46cd")) DUIAnimateManager;
struct __declspec(uuid("f62e2d42-63f3-4711-a89e-ff8ad06052d1")) _IDUIAnimateManagerEvents;
struct __declspec(uuid("46933eab-c45f-4cfd-b82f-e9ed64ab59b8")) IDUICheckForYY;
struct __declspec(uuid("53ac1c4e-c98d-4df9-b4a0-ad0120e83b8c")) DUICheckForYY;
...
struct __declspec(uuid("fa6686f1-e375-40f6-b983-15c93e84b047")) DUI_REG_MSG_INFO;
...
struct IDUIControlBase;
struct __declspec(uuid("b143f497-cdec-4a2f-b903-530228d4bdb1")) IDUIControlBase_;
...
struct ISkinObjResBase;
struct __declspec(uuid("936c7adf-65af-4807-8434-474243ddeb26")) ISkinObjResBase_;
enum DUIObjType;

struct __declspec(uuid("f0a6b880-d1d3-4f9e-9e06-ba340130a26d")) IDUIRes;
struct IDUIObj;
struct __declspec(uuid("932cf3c4-9cff-42b9-8fe7-0e246e888eab")) IDUIObj_;
...
{ 
	...
	DUISM_ENDDRAG = 1897,
	DUISM_ENDDRAG_NOTIFYFROMOBJ = 1926,
	DUISM_ENDRESIZE = 1925,
	...
	DUISM_TIMER = 1873,
	DUISM_TOOLTIPRELAY = 1927,
	DUISM_USER_SETFOCUS = 1922,
	DUISM_VISIBLE = 1928,
	DUI_IGNORE_DEFALT_MSG = 1024 
};
...
struct __declspec(uuid("932cf3c4-9cff-42b9-8fe7-0e246e888eab")) IDUIObj_ : IDispatch
{
	//
	//Property
	//
	...
	virtual HRESULT __stdcall raw_GetCSRBindingDataCount(int *pResult) = 0;
	virtual HRESULT __stdcall raw_GetCSRBindingName(int nIndex, BSTR *pResult) = 0;
	virtual HRESULT __stdcall raw_GetCSRBindingID(int nIndex, BSTR *pResult) = 0;
	...
	BOOL  IsDesignStatus();
	int  GetCSRBindingDataCount();
	tstring  GetCSRBindingName(int  nIndex  );
	tstring  GetCSRBindingID(int  nIndex  );
};

struct IDUIObj : CtrlBase
{
...
struct __declspec(uuid("d0ab9acc-2c46-4198-a091-54e117e9677c")) ISkinShareBase : IDUIObj_
{
	//
	//Property
	//
...
struct __declspec(uuid("f0a6b880-d1d3-4f9e-9e06-ba340130a26d")) IDUIRes : IDispatch
{
	...
	virtual HRESULT __stdcall raw_GetResObject(enum DUIObjType eType, BSTR strName, struct ISkinObjResBase *pObjParent, VARIANT_BOOL bDeep, OLE_HANDLE *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_SetDpi(float fDpi, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_SetUpdateTime(int nUpdateTime, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_ReleasePluginResObject(OLE_HANDLE pPlugin  ) = 0;
	virtual HRESULT __stdcall raw_CreatePluginResObject(BSTR strGuid, struct IDUIControlBase **pResult) = 0;
	virtual HRESULT __stdcall raw_IsRegKbHookObj(OLE_HANDLE pObject, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_RegisterKbHookObj(OLE_HANDLE pObject, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_UnRegisterKbHookObj(OLE_HANDLE pObject, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_CallNextKBHook(long nCode, OLE_HANDLE wParam, OLE_HANDLE lParam, long *pResult) = 0;
	virtual HRESULT __stdcall raw_IsRegisterHookObject(enum DUI_HOOKTYPE dwHookType, OLE_HANDLE pObject, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_RegisterHookObject(enum DUI_HOOKTYPE dwHookType, OLE_HANDLE pObject, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_UnRegisterHookObject(enum DUI_HOOKTYPE dwHookType, OLE_HANDLE pObject, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_CreateDirectUI2(BSTR strName, OLE_HANDLE hWndParent, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetResObject2(enum DUIObjType eType, BSTR strName, OLE_HANDLE pObjParent, VARIANT_BOOL bDeep, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_AddPluginResObject3(struct IDUIObj *pOwnerObj, BSTR strName, BSTR strGuid, VARIANT_BOOL bIsComposeCtrl, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_AddPluginResObject4(struct IDUIObj *pOwnerObj, BSTR strName, BSTR strGuid, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetResObjectByGuid2(enum DUIObjType eType, BSTR strGuid, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetCtrlPtrFromDataBlock(OLE_HANDLE hDataBlock, struct IDUIControlBase **pResult) = 0;
	...
	OLE_HANDLE  GetResObject(enum DUIObjType  eType, tstring  strName, struct ISkinObjResBase * pObjParent, BOOL  bDeep  );
	...
	BOOL  SetDpi(float  fDpi  );
	BOOL  SetUpdateTime(int  nUpdateTime  );
	...
	void ReleasePluginResObject(OLE_HANDLE  pPlugin  );
	struct IDUIControlBase * CreatePluginResObject(tstring  strGuid  );
	BOOL  IsRegKbHookObj(OLE_HANDLE  pObject  );
	BOOL  RegisterKbHookObj(OLE_HANDLE  pObject  );
	BOOL  UnRegisterKbHookObj(OLE_HANDLE  pObject  );
	long  CallNextKBHook(long  nCode, OLE_HANDLE  wParam, OLE_HANDLE  lParam  );
	BOOL  IsRegisterHookObject(enum DUI_HOOKTYPE  dwHookType, OLE_HANDLE  pObject  );
	BOOL  RegisterHookObject(enum DUI_HOOKTYPE  dwHookType, OLE_HANDLE  pObject  );
	BOOL  UnRegisterHookObject(enum DUI_HOOKTYPE  dwHookType, OLE_HANDLE  pObject  );
	BOOL  StartHook();
	BOOL  EndHook();
	...
	OLE_HANDLE  CreateDirectUI2(tstring  strName, OLE_HANDLE  hWndParent  );
	OLE_HANDLE  GetResObject2(enum DUIObjType  eType, tstring  strName, OLE_HANDLE  pObjParent, BOOL  bDeep  );
	OLE_HANDLE  AddPluginResObject3(struct IDUIObj * pOwnerObj, tstring  strName, tstring  strGuid, BOOL  bIsComposeCtrl  );
	OLE_HANDLE  AddPluginResObject4(struct IDUIObj * pOwnerObj, tstring  strName, tstring  strGuid  );
	OLE_HANDLE  GetResObjectByGuid2(enum DUIObjType  eType, tstring  strGuid  );
	struct IDUIControlBase * GetCtrlPtrFromDataBlock(OLE_HANDLE  hDataBlock  );
...
struct __declspec(uuid("936c7adf-65af-4807-8434-474243ddeb26")) ISkinObjResBase_ : IDUIObj_
{
	//
	//Property
	//
	...
	virtual HRESULT __stdcall raw_GetParent(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetParent(OLE_HANDLE pObjParent  ) = 0;
	virtual HRESULT __stdcall raw_GetRoot(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_IsExisted(OLE_HANDLE pObj, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_AddSubObject(OLE_HANDLE pSubObj, VARIANT_BOOL bInsertFirst, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_MoveAhead(OLE_HANDLE pSubObj, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_MoveBack(OLE_HANDLE pSubObj, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_Remove(VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_GetSubObject(short nIndex, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_RemoveAllSubObjects() = 0;
	virtual HRESULT __stdcall raw_GetSubObjIndex(OLE_HANDLE pSubObj, short *pResult) = 0;
	virtual HRESULT __stdcall raw_GetChildCount(short *pResult) = 0;
	virtual HRESULT __stdcall raw_GetSubCaptionObject(BSTR strCaption, short *pnIndex, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetSubResObject(OLE_HANDLE pObj, short *pnIndex, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetObjectByCaption(long lType, BSTR strName, VARIANT_BOOL bDeep, OLE_HANDLE *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_RemoveSubObject(OLE_HANDLE pSubObj, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_InsertSubObject(OLE_HANDLE pSubObj, short nIndex, short *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_MoveTop(OLE_HANDLE pSubObj, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_MoveBottom(OLE_HANDLE pSubObj, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_ReleasePosRect() = 0;
	virtual HRESULT __stdcall raw_AppendEventReceiver(OLE_HANDLE hReceiver  ) = 0;
	virtual HRESULT __stdcall raw_CallMsgFun(long nMsgID, UINT_PTR wParam, LONG_PTR lParam  ) = 0;
	virtual HRESULT __stdcall raw_RemoveEventReceiver(OLE_HANDLE hReceiver  ) = 0;
	virtual HRESULT __stdcall raw_SetCustomTimer(unsigned int nId, unsigned int nElapse, long *pResult) = 0;
	virtual HRESULT __stdcall raw_KillCustomTimer(unsigned int nId, long *pResult) = 0;
	...
	ISkinObjResBase* GetParent();
	void SetParent(OLE_HANDLE  pObjParent  );
	OLE_HANDLE  GetRoot();
	BOOL  IsExisted(OLE_HANDLE  pObj  );
	BOOL  AddSubObject(OLE_HANDLE  pSubObj, BOOL  bInsertFirst  );
	BOOL  MoveAhead(OLE_HANDLE  pSubObj  );
	BOOL  MoveBack(OLE_HANDLE  pSubObj  );
	BOOL  Remove();
	OLE_HANDLE  GetSubObject(short  nIndex  );
	void RemoveAllSubObjects();
	short  GetSubObjIndex(OLE_HANDLE  pSubObj  );
	short  GetChildCount();
	OLE_HANDLE  GetSubCaptionObject(tstring  strCaption, short * pnIndex  );
	OLE_HANDLE  GetSubResObject(OLE_HANDLE  pObj, short * pnIndex  );
	IDUIControlBase* GetObjectByCaption(long  lType, tstring  strName, BOOL  bDeep  );
	void DelAllSubObjects();
	void SetPosition(struct IDUIPos * pObjPos  );
	void ResizeThis();
	void Center();
	BOOL  RemoveSubObject(OLE_HANDLE  pSubObj  );
	short  InsertSubObject(OLE_HANDLE  pSubObj, short  nIndex  );
	...
	BOOL  MoveTop(OLE_HANDLE  pSubObj  );
	...
	BOOL  MoveBottom(OLE_HANDLE  pSubObj  );
	void MirrorObject(BOOL  bMirrorObj  );
	BOOL  IsMirrorObject();
	void ReleasePosRect();
	void AppendEventReceiver(OLE_HANDLE  hReceiver  );
	void CallMsgFun(long  nMsgID, UINT_PTR  wParam, LONG_PTR  lParam  );
	void RemoveEventReceiver(OLE_HANDLE  hReceiver = 0  );
	long  SetCustomTimer(unsigned int  nId, unsigned int  nElapse  );
	long  KillCustomTimer(unsigned int  nId  );
};

struct ISkinObjResBase : IDUIObj
{
	...
	BOOL  MoveBack(OLE_HANDLE  pSubObj  );
	BOOL  Remove();
	ISkinObjResBase* GetSubObject(short nIndex  );
 	void RemoveAllSubObjects();
	short  GetSubObjIndex(OLE_HANDLE  pSubObj  );
	short  GetChildCount();
	OLE_HANDLE  GetSubCaptionObject(tstring  strCaption, short * pnIndex  );
	ISkinObjResBase* GetSubResObject(OLE_HANDLE  pObj, short * pnIndex);
 	IDUIControlBase* GetObjectByCaption(long  lType, tstring  strName, BOOL  bDeep  );
	void DelAllSubObjects();
	void SetPosition(struct IDUIPos * pObjPos  );
	void ResizeThis();
...
struct __declspec(uuid("1c43a9bd-c603-4592-bfbe-790561c4f6bb")) IDUIPicture : ISkinWithRealResBase
{
	...
	virtual HRESULT __stdcall raw_GetPictureData(OLE_HANDLE *pPicData, long *pResult) = 0;
	...
	long  GetPictureData(OLE_HANDLE * pPicData  );
};
...
struct __declspec(uuid("b3ad51eb-77be-44d4-959e-2244ab8c5718")) IDUIRenderDC : IDispatch
{
	...
	virtual HRESULT __stdcall raw_SetCurrentControl(OLE_HANDLE pControlBase  ) = 0;
	virtual HRESULT __stdcall raw_GetCurrentControl(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetHDCNoAlpha(long nWidht, long nHeight, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_DrawTransformImage(struct IDUIRenderImage *pImage, float posX, float posY, float RotCenterX, float RotCenterY, float RotAngle, float ScaleCenterX, float ScaleCenterY, float ScaleX, float ScaleY, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_CalcTransform(float *pOutMatrix16, float posX, float posY, float RotCenterX, float RotCenterY, float RotAngle, float ScaleCenterX, float ScaleCenterY, float ScaleX, float ScaleY  ) = 0;
	virtual HRESULT __stdcall raw_TransformPoint2DArray(float *pOutArray8, float *pMatrix16, float width, float height, struct SkinRect *pResult) = 0;
	virtual HRESULT __stdcall raw_DrawImageVertices(struct IDUIRenderImage *pImage, float *pointArr8, VARIANT_BOOL *pResult) = 0;
	...
	OLE_HANDLE  GetDC();
	long  GetType();
	void SetCurrentControl(OLE_HANDLE  pControlBase  );
	OLE_HANDLE  GetCurrentControl();
	OLE_HANDLE  GetHDCNoAlpha(long  nWidht, long  nHeight  );
	BOOL  DrawTransformImage(struct IDUIRenderImage * pImage, float  posX, float  posY, float  RotCenterX, float  RotCenterY, float  RotAngle, float  ScaleCenterX, float  ScaleCenterY, float  ScaleX, float  ScaleY  );
	void CalcTransform(float * pOutMatrix16, float  posX, float  posY, float  RotCenterX, float  RotCenterY, float  RotAngle, float  ScaleCenterX, float  ScaleCenterY, float  ScaleX, float  ScaleY  );
	struct SkinRect  TransformPoint2DArray(float * pOutArray8, float * pMatrix16, float  width, float  height  );
	BOOL  DrawImageVertices(struct IDUIRenderImage * pImage, float * pointArr8  );
};
...
struct __declspec(uuid("533b8057-9b33-4c2a-b643-35cc61df5e33")) IDUIRenderImage : IDispatch
{
	...
	virtual HRESULT __stdcall raw_GetBits(long nScanLine, OLE_HANDLE *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_IsSprite(VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_AsSprite(VARIANT_BOOL AsSprite  ) = 0;
	virtual HRESULT __stdcall raw_SetSpritePosInfo(float posX, float posY  ) = 0;
	virtual HRESULT __stdcall raw_GetSpritePosInfo(float *pPosX, float *pPosY  ) = 0;
	virtual HRESULT __stdcall raw_SetSpriteRotInfo(float RotCenterX, float RotCenterY, float RotAngle  ) = 0;
	virtual HRESULT __stdcall raw_GetSpriteRotInfo(float *pRotCenterX, float *pRotCenterY, float *pRotAngle  ) = 0;
	virtual HRESULT __stdcall raw_SetSpriteScaleInfo(float ScaleCenterX, float ScaleCenterY, float ScaleX, float ScaleY  ) = 0;
	virtual HRESULT __stdcall raw_GetSpriteScaleInfo(float *pScaleCenterX, float *pScaleCenterY, float *pScaleX, float *pScaleY  ) = 0;
	virtual HRESULT __stdcall raw_UpdateSpriteState() = 0;
	virtual HRESULT __stdcall raw_GetSpriteBound(struct SkinRect *pResult) = 0;
	virtual HRESULT __stdcall raw_SetPoints(float *points  ) = 0;
	virtual HRESULT __stdcall raw_SetManual(VARIANT_BOOL bManual  ) = 0;
	virtual HRESULT __stdcall raw_LoadExternalBmp(OLE_HANDLE hHandle, long nWidth, long nHeight  ) = 0;
	virtual HRESULT __stdcall raw_SetBmpAngle(float angle  ) = 0;
	virtual HRESULT __stdcall raw_SetBmpScale(float scale  ) = 0;
	...
	OLE_HANDLE  GetBits(long  nScanLine  );
	short  GetColorDepth();
	...
	BOOL  IsSprite();
	void AsSprite(BOOL  AsSprite  );
	void SetSpritePosInfo(float  posX, float  posY  );
	void GetSpritePosInfo(float * pPosX, float * pPosY  );
	void SetSpriteRotInfo(float  RotCenterX, float  RotCenterY, float  RotAngle  );
	void GetSpriteRotInfo(float * pRotCenterX, float * pRotCenterY, float * pRotAngle  );
	void SetSpriteScaleInfo(float  ScaleCenterX, float  ScaleCenterY, float  ScaleX, float  ScaleY  );
	void GetSpriteScaleInfo(float * pScaleCenterX, float * pScaleCenterY, float * pScaleX, float * pScaleY  );
	void UpdateSpriteState();
	struct SkinRect  GetSpriteBound();
	void SetPoints(float * points  );
	void SetManual(BOOL  bManual  );
	void LoadExternalBmp(OLE_HANDLE  hHandle, long  nWidth, long  nHeight  );
	void SetBmpAngle(float  angle  );
	void SetBmpScale(float  scale  );
};
...
struct __declspec(uuid("118c0877-b832-4c18-bfbf-7a112483b6af")) IDUITextStyle : ISkinShareBase
{
	...
	virtual HRESULT __stdcall raw_DrawTextWithGdiPlus(OLE_HANDLE hDC, BSTR strText, struct SkinRect rect, VARIANT_BOOL bCalcDraw, long nUserFormat, struct SkinRect *pRectCalc, VARIANT_BOOL *pResult) = 0;
	...
	BOOL  DrawTextWithGdiPlus(OLE_HANDLE  hDC, tstring  strText, struct SkinRect  rect, BOOL  bCalcDraw, long  nUserFormat, struct SkinRect * pRectCalc = 0  );
};
...
struct __declspec(uuid("b143f497-cdec-4a2f-b903-530228d4bdb1")) IDUIControlBase_ : ISkinObjResBase_
{
	//
	//Property
	//
	...
	virtual HRESULT __stdcall raw_Clone(OLE_HANDLE pObjParent, OLE_HANDLE *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_AddPlugInObj(OLE_HANDLE pPluginObj  ) = 0;
	virtual HRESULT __stdcall raw_RemovePlugInObj(OLE_HANDLE pPluginObj  ) = 0;
	...
	virtual HRESULT __stdcall raw_AddMsgCallback(long nMsgID, OLE_HANDLE hFuncCallback, struct DUI_REG_MSG_INFO info, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_CreateDataBlock(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetDataBlock(OLE_HANDLE hHandle  ) = 0;
	virtual HRESULT __stdcall raw_ReleaseDataBlock(OLE_HANDLE hHandle  ) = 0;
	virtual HRESULT __stdcall raw_GetDataBlock(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_FindGroupProp(struct ICtrlPluginProp *pParentProp, BSTR strPropName, struct ICtrlPluginProp **pResult) = 0;
	virtual HRESULT __stdcall raw_FindProp(struct ICtrlPluginProp *pPropParent, enum enumPropType eType, BSTR strPropName, BSTR strPropHelp, VARIANT_BOOL bIsStyle, struct IPropChangedCallback *pCallback, struct IDUIPropBase **pResult) = 0;
	virtual HRESULT __stdcall raw_CloneDataBlock(OLE_HANDLE pSkinObjPtr, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetDUIControlFromDataBlock(OLE_HANDLE hHandle, struct IDUIControlBase **pResult) = 0;
	virtual HRESULT __stdcall raw_Clone2(OLE_HANDLE pObjParent, OLE_HANDLE *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_GetCtrlBitmap(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetFlatToolTip(VARIANT_BOOL bFlatToolTip  ) = 0;
	virtual HRESULT __stdcall raw_GetFlatToolTip(VARIANT_BOOL *pResult) = 0;
	...
	OLE_HANDLE  Clone(OLE_HANDLE  pObjParent  );
	...
	void Load();
	void AddPlugInObj(OLE_HANDLE  pPluginObj  );
	void RemovePlugInObj(OLE_HANDLE  pPluginObj  );
	...
	BOOL  IsDrawFocus();
	BOOL  AddMsgCallback(long  nMsgID, OLE_HANDLE  hFuncCallback, struct DUI_REG_MSG_INFO  info  );
	...
	OLE_HANDLE  CreateDataBlock();
	void SetDataBlock(OLE_HANDLE  hHandle  );
	void ReleaseDataBlock(OLE_HANDLE  hHandle  );
	OLE_HANDLE  GetDataBlock();
	struct ICtrlPluginProp * FindGroupProp(struct ICtrlPluginProp * pParentProp, tstring  strPropName  );
	struct IDUIPropBase * FindProp(struct ICtrlPluginProp * pPropParent, enum enumPropType  eType, tstring  strPropName, tstring  strPropHelp, BOOL  bIsStyle, struct IPropChangedCallback * pCallback  );
	OLE_HANDLE  CloneDataBlock(OLE_HANDLE  pSkinObjPtr  );
	struct IDUIControlBase * GetDUIControlFromDataBlock(OLE_HANDLE  hHandle  );
	OLE_HANDLE  Clone2(OLE_HANDLE  pObjParent  );
	...
	OLE_HANDLE  GetCtrlBitmap();
	void SetFlatToolTip(BOOL  bFlatToolTip  );
	BOOL  GetFlatToolTip();
};

struct IDUIControlBase : ISkinObjResBase
{
...
struct __declspec(uuid("86d01378-75ad-42fc-8f3b-99f796d89a18")) IDUIObjectDraw : IDispatch
{
	...
	//Method
	//
	virtual HRESULT __stdcall raw_BeginDraw(OLE_HANDLE hDC, OLE_HANDLE pObject, VARIANT_BOOL bDrawCurrent, VARIANT_BOOL bMemDC  ) = 0;
	...
	//Method Wrapper
	//
	void BeginDraw(OLE_HANDLE  hDC, OLE_HANDLE  pObject, BOOL  bDrawCurrent, BOOL  bMemDC  );
	void EndDraw();
...
struct __declspec(uuid("9b178567-37f3-4229-8286-234217f0a2fa")) ICtrlPluginProp : IDispatch
{
	...
	virtual HRESULT __stdcall raw_GetControlBasePtr(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetControlBasePtr(OLE_HANDLE pCtrlBase  ) = 0;
	virtual HRESULT __stdcall raw_AccessConfig2(BSTR strParentName, BSTR strScriptName, OLE_HANDLE pXmlEle, VARIANT_BOOL bRead, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_SetRenderDevice(OLE_HANDLE pDevice  ) = 0;
	virtual HRESULT __stdcall raw_FindGroupProp(BSTR strPropName, struct ICtrlPluginProp **pResult) = 0;
	virtual HRESULT __stdcall raw_FindProp(enum enumPropType eType, BSTR strPropName, BSTR strPropHelp, VARIANT_BOOL bIsStyle, struct IPropChangedCallback *pCallback, struct IDUIPropBase **pResult) = 0;
	...
	OLE_HANDLE  GetControlBasePtr();
	void SetControlBasePtr(OLE_HANDLE  pCtrlBase  );
	BOOL  AccessConfig2(tstring  strParentName, tstring  strScriptName, OLE_HANDLE  pXmlEle, BOOL  bRead  );
	...
	void SetRenderDevice(OLE_HANDLE  pDevice  );
	struct ICtrlPluginProp * FindGroupProp(tstring  strPropName  );
	struct IDUIPropBase * FindProp(enum enumPropType  eType, tstring  strPropName, tstring  strPropHelp, BOOL  bIsStyle, struct IPropChangedCallback * pCallback  );
};
...
struct __declspec(uuid("8425da30-24dd-43c2-b0c9-5ef2bf80929a")) IDUIPropBase : IDispatch
{
	...
	virtual HRESULT __stdcall raw_GetRenderType(enum DUI_RENDERENGINE_TYPE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetControlBase(struct IDUIControlBase *pCtrl  ) = 0;
	virtual HRESULT __stdcall raw_GetControlBase(struct IDUIControlBase **pResult) = 0;
	virtual HRESULT __stdcall raw_GetPropDataPtr(struct IDUIPropBase *pProp, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetPropDataPtr(struct IDUIPropBase *pProp, OLE_HANDLE pPropDataPtr, OLE_HANDLE dataSize  ) = 0;
	virtual HRESULT __stdcall raw_ClonePropData(OLE_HANDLE pSrc, OLE_HANDLE *pResult  ) = 0;
	virtual HRESULT __stdcall raw_ReleasePropData(OLE_HANDLE pSrc  ) = 0;
	...
	enum DUI_RENDERENGINE_TYPE  GetRenderType();
	void SetControlBase(struct IDUIControlBase * pCtrl  );
	struct IDUIControlBase * GetControlBase();
	OLE_HANDLE  GetPropDataPtr(struct IDUIPropBase * pProp  );
	void SetPropDataPtr(struct IDUIPropBase * pProp, OLE_HANDLE  pPropDataPtr, OLE_HANDLE  dataSize  );
	void ClonePropData(OLE_HANDLE  pSrc, OLE_HANDLE * pResult  );
	void ReleasePropData(OLE_HANDLE  pSrc  );
};
...
struct __declspec(uuid("d8439554-a9c5-40c4-acee-6db948d15df2")) IPropChangedCallback : IUnknown
{
	...
	//Method
	//
	virtual HRESULT __stdcall raw_Do(OLE_HANDLE pControlBase  ) = 0;

	//
	//Method Wrapper
	//
	void Do(OLE_HANDLE  pControlBase  );
};
...
struct __declspec(uuid("600b0bdd-2ece-4e36-a349-456c7be9440f")) IDirectUI : ISkinObjResBase_
{
	//
	//Property
	//
	...
	virtual HRESULT __stdcall raw_RegisterMessage(unsigned long uMsg, OLE_HANDLE pObject, VARIANT_BOOL bChildrenNotify, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_UnRegisterMessage(unsigned long uMsg, OLE_HANDLE pObject, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_RemoveAllRegister() = 0;
	virtual HRESULT __stdcall raw_RegisterWholeMessage(OLE_HANDLE pObject, VARIANT_BOOL bChildrenNotify, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_UnRegisterWholeMessage(OLE_HANDLE pObject, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_GetHotObject(OLE_HANDLE *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_RegSyncMoveWindow(OLE_HANDLE hWnd, OLE_HANDLE pCtrl  ) = 0;
	virtual HRESULT __stdcall raw_AppendFinalCtrl(OLE_HANDLE pContrlBase  ) = 0;
	virtual HRESULT __stdcall raw_RemoveFinalCtrl(OLE_HANDLE pContrlBase  ) = 0;
	...
	virtual HRESULT __stdcall raw_GetDUIControlByPt(long nXPt, long nYPt, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetCaptureCtrl(OLE_HANDLE pCtrl  ) = 0;
	...
	virtual HRESULT __stdcall raw_GetDataHandle(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_ReleaseDataBlock() = 0;
	virtual HRESULT __stdcall raw_CreateDataBlock(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_RegisterDropTarget() = 0;
	virtual HRESULT __stdcall raw_RevokeDropTarget() = 0;
	...
	virtual HRESULT __stdcall raw_GetCurrentFocusObject(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_RegisterAcceptFile(OLE_HANDLE pCtrl, long nMode  ) = 0;
	virtual HRESULT __stdcall raw_RevokeAcceptFile(OLE_HANDLE pCtrl  ) = 0;
	virtual HRESULT __stdcall raw_SetDragPosition(struct DUIPosition *pPos  ) = 0;
	virtual HRESULT __stdcall raw_GetDragPosition(struct DUIPosition *pPos  ) = 0;
	virtual HRESULT __stdcall raw_SetVideoPlayerRect(struct SkinRect SkinRect  ) = 0;
	virtual HRESULT __stdcall raw_UpdateToolTip() = 0;
	virtual HRESULT __stdcall raw_RegisterAccecptHwnd(OLE_HANDLE hWnd  ) = 0;
	virtual HRESULT __stdcall raw_RevokeAcceptHwnd(OLE_HANDLE hWnd  ) = 0;
	virtual HRESULT __stdcall raw_GetAnimateManager(OLE_HANDLE *pResult) = 0;
	...
	BOOL  RegisterMessage(unsigned long  uMsg, OLE_HANDLE  pObject, BOOL  bChildrenNotify  );
	BOOL  UnRegisterMessage(unsigned long  uMsg, OLE_HANDLE  pObject  );
	void RemoveAllRegister();
	BOOL  RegisterWholeMessage(OLE_HANDLE  pObject, BOOL  bChildrenNotify  );
	BOOL  UnRegisterWholeMessage(OLE_HANDLE  pObject  );
	...
	void RegSyncMoveWindow(OLE_HANDLE  hWnd, OLE_HANDLE  pCtrl  );
	void AppendFinalCtrl(OLE_HANDLE  pContrlBase  );
	void RemoveFinalCtrl(OLE_HANDLE  pContrlBase  );
	...
	void SynMoveWindow();
	OLE_HANDLE  GetDUIControlByPt(long  nXPt, long  nYPt  );
	void SetCaptureCtrl(OLE_HANDLE  pCtrl  );
	void ReleaseCaptureCtrl();
	void DirectDrawImmediate();
	void FadeShow(BOOL  bShow, enum DUI_FADE_TYPE  FadeType  );
	void ReCalcRgn();
	BOOL  IsDraging();
	OLE_HANDLE  GetDataHandle();
	...
	OLE_HANDLE  GetCurrentFocusObject();
	void RegisterAcceptFile(OLE_HANDLE  pCtrl, long  nMode  );
	void RevokeAcceptFile(OLE_HANDLE  pCtrl  );
	void SetDragPosition(struct DUIPosition * pPos  );
	void GetDragPosition(struct DUIPosition * pPos  );
	void SetVideoPlayerRect(struct SkinRect  SkinRect  );
	void UpdateToolTip();
	void RegisterAccecptHwnd(OLE_HANDLE  hWnd  );
	void RevokeAcceptHwnd(OLE_HANDLE  hWnd  );
	OLE_HANDLE  GetAnimateManager();
};
...
struct __declspec(uuid("4ca4d223-a97e-45d7-9e03-c16fdaed3f22")) IComboProp : IDUIPropBase
{
	...
	virtual HRESULT __stdcall raw_GetSafeArrayData(long *pResult) = 0;
...
struct __declspec(uuid("79811451-25bd-4717-8739-c1055edbc9aa")) IScriptUtils : IDispatch
{
	...
	virtual HRESULT __stdcall raw_DUIDeleteBitmap(OLE_HANDLE pBitmap  ) = 0;
	...
	void DUIDeleteBitmap(OLE_HANDLE  pBitmap  );
};
...
struct __declspec(uuid("fe34cf4a-8b5d-4776-970e-374dfcb28bda")) IDUIGifFileInfo : IDispatch
{
	...
	virtual HRESULT __stdcall raw_GetGifAnimatePointer(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetGifHBitmap() = 0;
	virtual HRESULT __stdcall raw_GetEachFrameHBitmap(unsigned long FrameOrder, OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_GetGifDelayTime(unsigned long *pResult) = 0;
	...
	OLE_HANDLE  GetGifAnimatePointer();
	void GetGifHBitmap();
	OLE_HANDLE  GetEachFrameHBitmap(unsigned long  FrameOrder  );
	unsigned long  GetGifDelayTime();
};

struct __declspec(uuid("46933eab-c45f-4cfd-b82f-e9ed64ab59b8")) IDUICheckForYY : IDispatch
{
	//
	//Property
	//
...
struct __declspec(uuid("f62e2d42-63f3-4711-a89e-ff8ad06052d1")) _IDUIAnimateManagerEvents : IDispatch
{
	//
	//Property
	//
...
struct __declspec(uuid("c7033505-0a8f-4412-bd54-93f89db162cd")) IDUIAnimateManager : IDispatch
{
	//
	//Property
	//
	...
	//Method
	//
	virtual HRESULT __stdcall raw_PlayAllAnimates() = 0;
	virtual HRESULT __stdcall raw_PauseAllAnimates() = 0;
	virtual HRESULT __stdcall raw_RemoveAllAnimates() = 0;
	virtual HRESULT __stdcall raw_RemoveAnimate(BSTR lpNameAnimate  ) = 0;
	virtual HRESULT __stdcall raw_RemoveAnimateByIndex(long nIndex  ) = 0;
	virtual HRESULT __stdcall raw_CreateAnimate(enum DUI_ANIMATE_TYPE eType, BSTR strName, VARIANT_BOOL bAutoPlay, VARIANT_BOOL bAutoDestroy, VARIANT_BOOL bAddAnimate, struct IDUICtrlAniBase **pResult) = 0;
	virtual HRESULT __stdcall raw_SetObjPtr(OLE_HANDLE pAniManager  ) = 0;
	virtual HRESULT __stdcall raw_GetAniByName(BSTR strName, struct IDUICtrlAniBase **pResult) = 0;
	virtual HRESULT __stdcall raw_AddAnimate(struct IDUICtrlAniBase *pAnimate  ) = 0;

	//
	//Method Wrapper
	//
	void PlayAllAnimates();
	void PauseAllAnimates();
	void RemoveAllAnimates();
	void RemoveAnimate(tstring  lpNameAnimate  );
	void RemoveAnimateByIndex(long  nIndex  );
	struct IDUICtrlAniBase * CreateAnimate(enum DUI_ANIMATE_TYPE  eType, tstring  strName, BOOL  bAutoPlay, BOOL  bAutoDestroy, BOOL  bAddAnimate  );
	void SetObjPtr(OLE_HANDLE  pAniManager  );
	struct IDUICtrlAniBase * GetAniByName(tstring  strName  );
	void AddAnimate(struct IDUICtrlAniBase * pAnimate  );
};
...
{ 
	DUI_ANITYPE_LAST = 2,
	DUI_ANITYPE_MOVE = 0,
	DUI_ANITYPE_RESIZE = 1 
};

struct __declspec(uuid("7a812e9f-4407-43d7-908f-188ff9618607")) IDUICtrlAniBase : IDispatch
{
	//
	//Property
	//
	...
	//Method
	//
	virtual HRESULT __stdcall raw_Play(VARIANT_BOOL bInit, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_Stop(VARIANT_BOOL bNeedResume  ) = 0;
	virtual HRESULT __stdcall raw_Pause() = 0;
	virtual HRESULT __stdcall raw_Resume() = 0;
	virtual HRESULT __stdcall raw_SetAnimateObjPtr(OLE_HANDLE pObj  ) = 0;
	virtual HRESULT __stdcall raw_GetAnimateObjPtr(OLE_HANDLE *pResult) = 0;
	virtual HRESULT __stdcall raw_SetParentRect(struct IDUIRect *rcParent  ) = 0;
	virtual HRESULT __stdcall raw_GetParentRect(struct SkinRect *pResult) = 0;
	virtual HRESULT __stdcall raw_SetCycleTime(unsigned int nCycleTime  ) = 0;
	virtual HRESULT __stdcall raw_SetStepTime(unsigned int nStepTime  ) = 0;
	virtual HRESULT __stdcall raw_GetCycleTime(unsigned int *pResult) = 0;
	virtual HRESULT __stdcall raw_GetStepTime(unsigned int *pResult) = 0;
	virtual HRESULT __stdcall raw_IsPlaying(VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_GetName(BSTR *pResult) = 0;
	virtual HRESULT __stdcall raw_SetName(BSTR pName  ) = 0;
	virtual HRESULT __stdcall raw_SetAnimateBase(OLE_HANDLE pAnimateBase  ) = 0;
	virtual HRESULT __stdcall raw_GetAnimateBase(OLE_HANDLE *pResult) = 0;

	//
	//Method Wrapper
	//
	BOOL  Play(BOOL  bInit  );
	void Stop(BOOL  bNeedResume  );
	void Pause();
	void Resume();
	void SetAnimateObjPtr(OLE_HANDLE  pObj  );
	OLE_HANDLE  GetAnimateObjPtr();
	void SetParentRect(struct IDUIRect * rcParent  );
	struct SkinRect  GetParentRect();
	void SetCycleTime(unsigned int  nCycleTime  );
	void SetStepTime(unsigned int  nStepTime  );
	unsigned int  GetCycleTime();
	unsigned int  GetStepTime();
	BOOL  IsPlaying();
	tstring  GetName();
	void SetName(tstring  pName  );
	void SetAnimateBase(OLE_HANDLE  pAnimateBase  );
	OLE_HANDLE  GetAnimateBase();
};

struct __declspec(uuid("fe686e80-1411-4c0d-87f3-7269e97bba4c")) _IDUICtrlAniBaseEvents : IDispatch
{
	//
	//Property
	//
...
struct __declspec(uuid("27ba8f99-fc72-4e00-b5cb-4f24416fb1cc")) _IDUICtrlAniMoveEvents : IDispatch
{
	//
	//Property
	//
...
struct __declspec(uuid("2ace08b1-723d-490d-a7f9-fae5fc67b2ca")) IDUICtrlAniMove : IDUICtrlAniBase
{
	//
	//Property
	//
	...
	//Method
	//
	virtual HRESULT __stdcall raw_SetMoveParam(struct SkinPoint ptFrom, struct SkinPoint ptTo  ) = 0;
	virtual HRESULT __stdcall raw_SetStepRange(unsigned int nXStep, unsigned int nYStep  ) = 0;
	virtual HRESULT __stdcall raw_UserSetMoveStep(VARIANT_BOOL varUserSet  ) = 0;
	virtual HRESULT __stdcall raw_SetObjPtr(OLE_HANDLE pAniMove  ) = 0;

	//
	//Method Wrapper
	//
	void SetMoveParam(struct SkinPoint  ptFrom, struct SkinPoint  ptTo  );
	void SetStepRange(unsigned int  nXStep, unsigned int  nYStep  );
	void UserSetMoveStep(BOOL  varUserSet  );
	void SetObjPtr(OLE_HANDLE  pAniMove  );
};

struct __declspec(uuid("a1d34dfb-e7fc-4df0-bc59-f5448b5e5994")) _IDUICtrlAniResizeEvents : IDispatch
{
	//
	//Property
	//
...
struct __declspec(uuid("3b1e89b6-61f4-4900-a231-266643ca00d2")) IDUICtrlAniResize : IDUICtrlAniBase
{
	//
	//Property
	//
	...
	//Method
	//
	virtual HRESULT __stdcall raw_SetResizeParam(unsigned int nDestLeft, unsigned int nDestTop, unsigned int nDestWidth, unsigned int nDestHeight  ) = 0;
	virtual HRESULT __stdcall raw_SetObjPtr(OLE_HANDLE pAniResize  ) = 0;

	//
	//Method Wrapper
	//
	void SetResizeParam(unsigned int  nDestLeft, unsigned int  nDestTop, unsigned int  nDestWidth, unsigned int  nDestHeight  );
	void SetObjPtr(OLE_HANDLE  pAniResize  );
};
